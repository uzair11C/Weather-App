...
function MultanWeather()
{
    ...
    const fetchWeather = async () => {
        const data = await fetch(
            "https://api.openweathermap.org/data/2.5/weather?q=multan&units=metric&appid=" + APIKey
            );
