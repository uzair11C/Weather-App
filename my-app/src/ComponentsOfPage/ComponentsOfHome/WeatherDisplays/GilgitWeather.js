...
function GilgitWeather()
{
    ...
    const fetchWeather = async () => {
        const data = await fetch(
            "https://api.openweathermap.org/data/2.5/weather?q=gilgit&units=metric&appid=" + APIKey
            );
