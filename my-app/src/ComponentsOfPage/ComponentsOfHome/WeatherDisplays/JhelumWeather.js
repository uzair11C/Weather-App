...
function JhelumWeather()
{
    ...
    const fetchWeather = async () => {
        const data = await fetch(
            "https://api.openweathermap.org/data/2.5/weather?q=jhelum&units=metric&appid=" + APIKey
            );
