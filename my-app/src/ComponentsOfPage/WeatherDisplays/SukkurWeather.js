...
function SukkurWeather()
{
    ...
    const fetchWeather = async () => {
        const data = await fetch(
            "https://api.openweathermap.org/data/2.5/weather?q=sukkur&units=metric&appid=" + APIKey
            );
